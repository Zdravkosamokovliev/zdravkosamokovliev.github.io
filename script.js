document.addEventListener('DOMContentLoaded', () => {
    ...
    const elements = {
        masterProgressContainer: document.querySelector('.master-progress-container'),
        masterProgressBarBG: document.getElementById('master-progress-bar'),
        masterProgressFill: document.getElementById('master-progress-fill'),
        masterCheckpointsContainer: document.getElementById('master-checkpoints'),
        totalProgressEl: document.getElementById('total-progress'),
        nextCheckpointNameEl: document.getElementById('next-checkpoint-name'),
        progressBarEl: document.getElementById('progress-bar'),
        progressTextEl: document.getElementById('progress-text'),
        addBlockBtn: document.getElementById('add-block-btn'),
        addFloorBtn: document.getElementById('add-floor-btn'),
        checkpointListEl: document.getElementById('checkpoint-list'),
        congratsPopup: document.getElementById('congrats-popup'),
        popupCheckpointName: document.getElementById('popup-checkpoint-name'),
    ...
    // --- НОВО: ЛОГИКА ЗА СТРЕЛКИТЕ ---
    const scrollAmount = 300; // С колко пиксела да се мести при клик
    elements.scrollLeftBtn.addEventListener('click', () => {
        elements.masterProgressContainer.scrollBy({
            left: -scrollAmount,
            behavior: 'smooth'
        });
    });
